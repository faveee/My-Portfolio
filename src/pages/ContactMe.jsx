...
<div className="p-10">
    ...
    <p className="MainTxt text-black">Have a frontend developer role you're looking to fill or a project with a need for my range of skill sets? I'm currently available to new opportunities. Kindly reach out!</p>
</div>
<div className="flex justify-center">
 ...
 text-white py-3 mb-5 px-10 text-center border-double hover:border-double border-4 rounded-lg"><a href="mailto:abatangift11@gmail.com">Let's talk</a></button>
    ...
    <div className="AweSome text-5xl flex justify-center gap-16 text-black py-10">
